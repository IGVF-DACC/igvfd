...
* Extend `content_type` enum list to include `differential open reading frame quantifications`.
...
* Extend `content_type` enum list to include `exon constraint`.
* Extend `content_type` enum list to include `marker gene activity`.
...
* Extend `content_type` enum list to include `gene universe`.
...
* Extend `content_type` enum list to include `barcode to donor mapping`.
