...
* Extend `output_content_types` enum list to include `annotated multimodal CRISPR features`.
* Extend `input_content_types` enum list to include `annotated multimodal CRISPR features`.
