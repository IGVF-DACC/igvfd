...
* Extend `input_content_types` enum list to include `gene-disease program regulators`.
* Extend `output_content_types` enum list to include `gene-disease program regulators`.
...
* Extend `output_content_types` enum list to include `reporter element accessibility effect`.
* Extend `input_content_types` enum list to include `cell by gene and peak and guide matrix`.
* Extend `output_content_types` enum list to include `cell by gene and peak and guide matrix`.
...
* Extend `output_content_types` enum list to include `marker genes`.
* Extend `analysis_step_types` enum list to include `pseudobulking`.
...
* Extend `analysis_step_types` enum list to include `cell annotation`.
* Extend `analysis_step_types` enum list to include `variant calling`.
...
* Extend `output_content_types` enum list to include `aggregated calibrated coding variant effects`.
...
* Extend `output_content_types` enum list to include `filtered global differential expressions`.
