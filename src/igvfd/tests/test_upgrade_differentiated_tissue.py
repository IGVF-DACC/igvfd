...
def test_differentiated_tissue_upgrade_4_to_5(upgrader,
                                              differentiated_tissue_4,
                                              differentiated_tissue_4_with_note,
                                              differentiated_tissue_4_good_value,
                                              differentiated_tissue_4_one_stage,
                                              differentiated_tissue_4_one_stage_with_note):
    value1 = upgrader.upgrade('differentiated_tissue',
                              differentiated_tissue_4,
                              current_version='4',
                              target_version='5')
    ...
    value2 = upgrader.upgrade('differentiated_tissue',
                              differentiated_tissue_4_with_note,
                              current_version='4',
                              target_version='5')
    ...
    value3 = upgrader.upgrade('differentiated_tissue',
                              differentiated_tissue_4_good_value,
                              current_version='4',
                              target_version='5')
    ...
    value4 = upgrader.upgrade('differentiated_tissue',
                              differentiated_tissue_4_one_stage,
                              current_version='4',
                              target_version='5')
    ...
    value5 = upgrader.upgrade('differentiated_tissue',
                              differentiated_tissue_4_one_stage_with_note,
                              current_version='4',
                              target_version='5')
