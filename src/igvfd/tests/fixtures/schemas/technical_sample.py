...
@pytest.fixture
def technical_sample_organic(testapp, other_lab, award, source, sample_term_technical_sample):
    item = {
        'award': award['@id'],
        'lab': other_lab['@id'],
        'sources': [source['@id']],
...
@pytest.fixture
def technical_sample_inorganic(testapp, other_lab, award, source, sample_term_technical_sample):
    item = {
        'award': award['@id'],
        'lab': other_lab['@id'],
        'sources': [source['@id']],
