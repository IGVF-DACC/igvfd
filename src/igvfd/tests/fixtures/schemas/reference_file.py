...
@pytest.fixture
def reference_file_with_transcriptome(testapp, lab, award, principal_analysis_set):
    item = {
        'award': award['@id'],
        'lab': lab['@id'],
        'md5sum': 'a77ba8fa105a74d2399e57d25fad4db1',
        'file_format': 'gtf',
        'file_set': principal_analysis_set['@id'],
        'content_type': 'transcriptome reference',
        'controlled_access': False,
...
@pytest.fixture
def reference_file_v17(reference_file_v6):
    item = reference_file_v6.copy()
    item.update({
        'schema_version': '17',
...
@pytest.fixture
def reference_file_v19(reference_file_v6):
    item = reference_file_v6.copy()
    item.update({
        'schema_version': '19',
        'external': True
