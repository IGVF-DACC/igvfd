...
def test_tabular_file_upgrade_13_14(upgrader, tabular_file_v13):
    value = upgrader.upgrade('tabular_file', tabular_file_v13, current_version='13', target_version='14')
