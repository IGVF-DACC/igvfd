...
def test_metadata_inequalties_relation_to_operator():
    from igvfd.metadata.inequalities import relation_to_operator
...
def test_metadata_inequalties_partial_inequality():
    from igvfd.metadata.inequalities import partial_inequality
    from igvfd.metadata.inequalities import relation_to_operator
...
def test_metadata_inequalities_parse_inequality_param_value():
...
def test_metadata_inequalities_make_inequality_from_relation_and_operand():
    from igvfd.metadata.inequalities import make_inequality_from_relation_and_right_operand
    inequality = make_inequality_from_relation_and_right_operand('lt', 3000)
    assert inequality(200)
    assert not inequality(5000)


def test_metadata_inequalities_map_param_values_to_inequalities():
...
def test_metadata_inequalities_try_to_evaluate_inequality():
    from igvfd.metadata.inequalities import map_param_values_to_inequalities
