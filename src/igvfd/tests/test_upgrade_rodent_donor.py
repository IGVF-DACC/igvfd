...
def test_rodent_donor_upgrade_14_15(upgrader, rodent_donor_v14):
    value = upgrader.upgrade('rodent_donor', rodent_donor_v14, current_version='14', target_version='15')
