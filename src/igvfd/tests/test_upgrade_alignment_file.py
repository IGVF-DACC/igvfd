...
def test_alignment_file_upgrade_10_11(upgrader, alignment_file_v11):
    ...
    assert alignment_file_v12['notes'].endswith('has been assigneed to be custom via an upgrade.')
    assert alignment_file_v10['schema_version'] == '12'
