...
def test_multiplexed_sample_asummary(testapp, multiplexed_sample, tissue, in_vitro_cell_line, human_tissue, primary_cell, sample_term_endothelial_cell, in_vitro_differentiated_cell, in_vitro_organoid, sample_term_brown_adipose_tissue, sample_term_lymphoblastoid):
