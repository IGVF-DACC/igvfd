...
def test_related_measurement_sets_series_type_multiome(testapp, primary_cell, in_vitro_cell_line, measurement_set, measurement_set_multiome, measurement_set_multiome_2, curated_set_genome):
    ...
    related_measurement_sets = res.json['related_measurement_sets']
    ...
    assert set([related_multiome_dataset['@id']
               for related_multiome_dataset in related_multiome_datasets]) == {measurement_set['@id']}
...
def test_related_measurement_sets_series_type_biological_replicates(testapp, tissue, primary_cell, in_vitro_cell_line, measurement_set, measurement_set_mpra):
...
def test_related_measurement_sets_series_type_sorted_fractions(testapp, primary_cell, tissue, in_vitro_cell_line, measurement_set, measurement_set_mpra):
...
def test_related_measurement_sets_series_type_treatment_time_series(testapp, tissue, primary_cell, in_vitro_cell_line, measurement_set, measurement_set_mpra, treatment_chemical, lab, award):
