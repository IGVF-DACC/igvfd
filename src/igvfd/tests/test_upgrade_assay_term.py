...
def test_assay_term_upgrade_18_19(upgrader, assay_term_v18):
    ...
    assert value.get('notes') == 'This assay_term previously used 10x scATAC with Scale pre-indexing as a preferred_assay_titles, but it has been updated to 10x scATAC with Scale pre-indexing via an upgrade.'
