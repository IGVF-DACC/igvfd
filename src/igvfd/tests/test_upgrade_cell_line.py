...
def test_cell_line_upgrade_6_7(upgrader, cell_line_v6):
    alias = cell_line_v6['aliases']
    alternate_accession = cell_line_v6['alternate_accessions']
    collection = cell_line_v6['collections']
    document = cell_line_v6['documents']
    treatment = cell_line_v6['treatments']
    disease_term = cell_line_v6['disease_terms']
    dbxref = cell_line_v6['dbxrefs']
    ...
    assert type(cell_line_v6['part_of']) is list
