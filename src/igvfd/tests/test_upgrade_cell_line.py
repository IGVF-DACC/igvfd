...
def test_cell_line_upgrade_1_2(upgrader, cell_line_1):
    value = upgrader.upgrade('cell_line', cell_line_1, current_version='1', target_version='2')
    assert value['schema_version'] == '2'


def test_cell_line_upgrade_2_3(upgrader, cell_line_2):
    value = upgrader.upgrade('cell_line', cell_line_2, current_version='2', target_version='3')
