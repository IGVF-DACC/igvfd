...
def test_measurement_set_upgrade_39_40(upgrader, measurement_set_v39_1, measurement_set_v39_2, measurement_set_v39_3):
    ...
    assert 'protocols' not in value
    assert value.get('notes') == 'This protocol(s) https://www.protocols.io/345/ABC do not start with https://www.protocols.io/private/ or https://www.protocols.io/view/ and were removed from the property list.'
