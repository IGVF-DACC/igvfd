...
def test_auxiliary_set_upgrade_12_13(upgrader, auxiliary_set_v12, tabular_file):
    value = upgrader.upgrade('auxiliary_set', auxiliary_set_v12, current_version='12', target_version='13')
    assert value['schema_version'] == '13'
    assert 'barcode_map' not in value
    assert 'hashtag_barcode_map' in value and value['hashtag_barcode_map'] == tabular_file['@id']
