...
class Sample(Item):
    ...
    embedded_with_frame = [
        ...
        Path('file_sets', include=['@id', 'accession', 'aliases',
             'lab', 'status', 'assay_titles', 'preferred_assay_titles', 'file_set_type']),
    ...
    @calculated_property(schema={
        ...
        'type': 'array',
        'description': 'The samples which originate from this sample, such as through a process of cell fate change or the introduction of a genetic material.',
        'minItems': 1,
        'uniqueItems': True,
        'items': {
...
class InVitroSystem(Biosample):
    ...
    @calculated_property(schema={
        ...
        'type': 'array',
        'description': 'The in vitro system samples this in vitro system sample has been demultiplexed into.',
        'minItems': 1,
        'uniqueItems': True,
        'items': {
            'title': 'Demultiplexed To',
...
class MultiplexedSample(Sample):
    ...
    def summary(self, request, multiplexed_samples=None, donors=None, sample_terms=None, cellular_sub_pool=None):
        ...
        if cellular_sub_pool:
            subpool_phrase = f'cellular sub-pool: {cellular_sub_pool}'
