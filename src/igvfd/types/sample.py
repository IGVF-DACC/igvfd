...
class MultiplexedSample(Sample):
    ...
    def summary(self, request, multiplexed_samples=None, donors=None, sample_terms=None):
        ...
        sample_term_phrase = compose_summary_sample_term_phrase(sample_term_term_names=sorted(sample_term_term_names),
        ...
        # Could nest under the same if conidtion above, but this is more readable
        ...
        if multiplexed_samples:
            ...
            targeted_sample_term_phrase = compose_summary_sample_term_phrase(
                sample_term_term_names=sorted(targeted_sample_term_names),
