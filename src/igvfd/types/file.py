...
class File(Item):
    ...
    embedded_with_frame = [
        ...
        Path('file_set.samples.disease_terms', include=[
             '@id', 'accession', 'status', 'summary', 'samples', 'disease_terms', 'sample_terms', 'term_name', 'classifications', 'file_set_type', 'taxa', 'targeted_sample_term', 'modifications', 'treatments', 'institutional_certificates']),
        ...
        Path('file_set.samples.institutional_certificates', include=['@id',
             'certificate_identifier', 'status', 'data_use_limitation', 'data_use_limitation_modifiers', 'data_use_limitation_summary', 'controlled_access']),
