...
class InstitutionalCertificate(Item):
    ...
    def data_use_limitation_summary(self, data_use_limitation=None, data_use_limitation_modifiers=None):
        limitation = data_use_limitation or 'No limitations'
        modifiers = data_use_limitation_modifiers or []
